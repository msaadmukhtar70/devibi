...
export default function PortfolioClient({ cases }) {
  // ---------------- Typography tokens ----------------
  const H2 =
  ...
  const jsonLd = {
    ...
    description:
      "Case studies showing how we help B2B SaaS founders launch and scale revenue-ready products. See the outcomes, timelines, and tech stacks.",
              ...
              >
                <div className="mx-auto md:max-w-xs lg:max-w-xl xl:max-w-[746px]">
                  ...
                  <p className={`${LEAD} mt-3 text-black/60`}>
                    Browse our work to see how we help B2B SaaS founders launch and scale. Each case study details the timeframe, outcome, stack, and the key metrics that drive growth.
                  </p>
                </div>
              </div>
